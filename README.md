...
1. The system folder located at C:\Windows\Temp.
2. Your personal user temporary folder found in the AppData directory.
...
1. Open the folder where you saved the cleaner.exe file.
2. Right-click the file icon.
3. Select Run as administrator from the menu. This step allows the tool to access protected system folders.
4. A small window will appear. The tool will start scanning the temporary directories.
5. Watch the screen for progress updates.
6. The window will close automatically when the process finishes.
